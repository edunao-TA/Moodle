...
BASE_TEMPLATE_URL=https://raw.githubusercontent.com/edunao-ta/moodle_azure_template/$CURRENT_BRANCH/nested/
echo "Base template URL: $BASE_TEMPLATE_URL"

SCRIPT_LOCATION=https://raw.githubusercontent.com/edunao-ta/moodle_azure_template/$CURRENT_BRANCH/scripts/
